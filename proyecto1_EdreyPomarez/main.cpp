...
int main()
{
    ...
    // Ya que un arreglo s�lo puede tener un s�lo tipo, decid� usar un sistemas de codigos.
    // El 50 hace referencia a la cantidad m�xima de pokemones que se pueden registrar.
    ...
    //[x][0] Indica si la casilla est� llena con valor 1, 0 si no lo est�.
    //[x][1] Se almacena el ID del Pok�mon.
    //[x][2] Se almacena la posicion en el que el tipo del
    // Pok�mon est� registrado en el arreglo tipoPokemon[]
    //[x][3] Se almacena el nivel de poder del Pok�mon.
    //
    ...
    // Ayudar� a manipular los datos.

    // Ayudar� a mantener el control del l�mite m�ximo de Pokemones.
